...
/**
 * ISO 3166-1 alpha-2 display names without requiring the PHP intl extension.
 */
class CountryNames
{
    /**
    ...
    public static function all(): array
    {
        return [
            ...
            'TC' => 'Turks and Caicos Islands', 'TV' => 'Tuvalu', 'VI' => 'U.S. Virgin Islands',
    ...
    public static function name(?string $code): ?string
    {
        ...
        return self::all()[$normalized] ?? $normalized;
    }
}
