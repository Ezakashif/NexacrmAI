        ...
        'product_showcase' => [
            ...
            'items' => [
                [
                    ...
                    'image' => '/marketing/screenshots/nexacrm-dashboard.png',
                ],
                [
                    'id' => 'leads',
                    'title' => 'Leads',
                    ...
                    'icon' => 'user-plus',
                    'image' => '/marketing/screenshots/nexacrm-leads.png',
                ],
                [
                    'id' => 'kanban',
                    'title' => 'Kanban board',
                    ...
                    'icon' => 'kanban',
                    'image' => '/marketing/screenshots/nexacrm-sales-pipeline.png',
                ],
                [
                    'id' => 'customers',
                    'title' => 'Customers',
                    ...
                    'icon' => 'users',
                    'image' => '/marketing/screenshots/nexacrm-customers.png',
                ],
                [
                    'id' => 'tasks',
                    'title' => 'Tasks',
                    ...
                    'icon' => 'check-square',
                    'image' => '/marketing/screenshots/nexacrm-tasks.png',
                ],
                [
                    'id' => 'reports',
                    ...
                    'icon' => 'bar-chart',
                    'image' => '/marketing/screenshots/nexacrm-reports.png',
                ],
                [
                    'id' => 'analytics',
                    ...
                    'icon' => 'bar-chart',
                    'image' => '/marketing/screenshots/nexacrm-analytics.png',
                ],
                [
                    'id' => 'activity',
                    'title' => 'Activity logs',
                    ...
                    'icon' => 'scroll-text',
                    'image' => '/marketing/screenshots/nexacrm-activity-log.png',
                ],
                [
                    'id' => 'roles',
                    ...
                    'icon' => 'shield',
                    'image' => '/marketing/screenshots/nexacrm-roles-permissions.png',
                ],
                [
                    'id' => 'company',
                    ...
                    'icon' => 'users',
                    'image' => '/marketing/screenshots/nexacrm-user-management.png',
                ],
            ],
        ],
        'features' => [
